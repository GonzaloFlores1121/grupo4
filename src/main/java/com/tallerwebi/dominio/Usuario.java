...
public class Usuario {
    ...
    public String getMetaAlcanzarPeso() {return metaAlcanzarPeso;}
    public void setMetaAlcanzarPeso(String metaAlcanzarPeso) {this.metaAlcanzarPeso = metaAlcanzarPeso;}    
